...
thomas_second_flat = Flat.new(user: thomas, address: "30 rue Broca, 75005, Paris", description: "Superbe studio très bien aménagé dans un quartier animé de la Rive Gauche.", monthly_price: 750, visible: true, rented: false, name: "Studio meublé Paris 13", number_of_rooms: 1, number_of_bedrooms: 1, surface: 25, floor: 5, elevator: false, balcony: false, cellar: true, parking: false, heating_system: ["", "individuel", "électrique"], furnished: true)
attach_photo_flat("https://images.unsplash.com/photo-1464890100898-a385f744067f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60", thomas_second_flat)
...
second_schedule = Schedule.create!(start:Time.new(2020, 3, 3, 9, 0, 0),end:Time.new(2020, 3, 3, 9, 30, 0),flat_id: thomas_second_flat)
third_schedule = Schedule.create!(start:Time.new(2020, 3, 4, 9, 30, 0),end:Time.new(2020, 3, 4, 10, 0, 0),flat_id: thomas_second_flat)
